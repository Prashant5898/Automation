...
public class PositiveTests {
	...
	public void registrationTest()
	{
		...
		sleep(1500);
		driver.findElement(By.name("email")).sendKeys("prashantpatil5898@gmail.com");
		sleep(1500);
		driver.findElement(By.name("password")).sendKeys("prashant*05");
		sleep(1500);
		driver.findElement(By.name("phone")).sendKeys("7028589858");
		sleep(1500);
